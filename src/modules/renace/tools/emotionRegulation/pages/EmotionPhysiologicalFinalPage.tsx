...
function EmotionPhysiologicalFinalPage() {
	...
	const handleFinish = () => {
		...
		registerIntervention({
			...
			exerciseId: "regulacion-fisiologica",
			exerciseTitle: "Regulación Fisiológica",
			completed: true,
		});
		finishSession();
		navigate("/renace");
...
export default EmotionPhysiologicalFinalPage;
