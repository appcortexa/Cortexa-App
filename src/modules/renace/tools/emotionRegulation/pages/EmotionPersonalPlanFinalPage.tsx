...
function EmotionPersonalPlanFinalPage() {
	...
	const handleFinish = () => {
		...
		registerIntervention({
			tool: "regulacion-emocional",
			exerciseId: "plan-personal-regulacion",
			exerciseTitle: "Plan Personal de Regulación",
			completed: true,
		});
		finishSession();
		navigate("/renace");
...
export default EmotionPersonalPlanFinalPage;
