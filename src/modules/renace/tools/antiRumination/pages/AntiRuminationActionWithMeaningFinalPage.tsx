...
function AntiRuminationActionWithMeaningFinalPage() {
	...
	const handleFinish = () => {
		...
		registerIntervention({
			tool: "antirrumiacion",
			exerciseId: "accion-con-sentido",
			exerciseTitle: "Acción con Sentido",
			completed: true,
		});
		finishSession();
		navigate("/renace");
...
export default AntiRuminationActionWithMeaningFinalPage;
