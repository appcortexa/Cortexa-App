...
function AntiRuminationDetectionFinalPage() {
	...
	const handleFinish = () => {
		...
		registerIntervention({
			tool: "antirrumiacion",
			exerciseId: "deteccion-rumiacion",
			exerciseTitle: "Detección de Rumiación",
			completed: true,
		});
		finishSession();
		navigate("/renace");
...
export default AntiRuminationDetectionFinalPage;