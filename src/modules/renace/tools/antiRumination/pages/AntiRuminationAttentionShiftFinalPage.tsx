...
function AntiRuminationAttentionShiftFinalPage() {
	...
	const handleFinish = () => {
		...
		registerIntervention({
			tool: "antirrumiacion",
			exerciseId: "cambio-atencion",
			exerciseTitle: "Cambio de Atención",
			completed: true,
		});
		finishSession();
		navigate("/renace");
...
export default AntiRuminationAttentionShiftFinalPage;