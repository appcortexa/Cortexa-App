...
function AntiRuminationPersonalPlanFinalPage() {
	...
	const handleFinish = () => {
		...
		registerIntervention({
			tool: "antirrumiacion",
			exerciseId: "aprendizajes",
			exerciseTitle: "Plan Personal Antirrumiación",
			completed: true,
		});
		finishSession();
		navigate("/renace");
...
export default AntiRuminationPersonalPlanFinalPage;
