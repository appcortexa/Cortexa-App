...
function SelfCompassionLetterFinalPage() {
	...
	const handleFinish = () => {
		...
		registerIntervention({
			tool: "autocompasion",
			exerciseId: "carta-compasiva-hacia-uno-mismo",
			exerciseTitle: "Carta compasiva hacia uno mismo",
			completed: true,
		});
		finishSession();
		navigate("/renace");
...
export default SelfCompassionLetterFinalPage;
