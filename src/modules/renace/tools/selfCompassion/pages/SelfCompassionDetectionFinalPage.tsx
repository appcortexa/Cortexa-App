...
function SelfCompassionDetectionFinalPage() {
	...
	const handleFinish = () => {
		...
		registerIntervention({
			tool: "autocompasion",
			exerciseId: "deteccion-dialogo-autocritico",
			exerciseTitle: "Detección del diálogo autocrítico",
			completed: true,
		});
		finishSession();
		navigate("/renace");
...
export default SelfCompassionDetectionFinalPage;
