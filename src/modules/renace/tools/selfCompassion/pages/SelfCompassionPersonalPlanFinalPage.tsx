...
function SelfCompassionPersonalPlanFinalPage() {
	...
	const handleFinish = () => {
		...
		setIsFinishing(true);
		registerIntervention({ tool: "autocompasion", exerciseId: "plan-personal-autocompasion", exerciseTitle: "Plan Personal de Autocompasión", completed: true });
		finishSession();
		navigate("/renace");
	};
...
export default SelfCompassionPersonalPlanFinalPage;
