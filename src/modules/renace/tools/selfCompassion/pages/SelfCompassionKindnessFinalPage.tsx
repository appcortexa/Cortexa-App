...
function SelfCompassionKindnessFinalPage() {
	...
	const handleFinish = () => {
		...
		registerIntervention({
			tool: "autocompasion",
			exerciseId: "responderse-con-amabilidad",
			exerciseTitle: "Responderse con amabilidad",
			completed: true,
		});
		finishSession();
		navigate("/renace");
...
export default SelfCompassionKindnessFinalPage;
