...
function SelfCompassionCommonHumanityFinalPage() {
	...
	const handleFinish = () => {
		...
		registerIntervention({
			tool: "autocompasion",
			exerciseId: "humanidad-compartida",
			exerciseTitle: "Humanidad Compartida",
			completed: true,
		});
		finishSession();
		navigate("/renace");
...
export default SelfCompassionCommonHumanityFinalPage;
