...
function ProtectiveFactorsFinalPage() {
	...
	const handleFinish = () => {
		...
		setIsFinishing(true);
		registerIntervention({ tool: "prevencion-recaidas", exerciseId: "factores-protectores", exerciseTitle: "Factores Protectores", completed: true });
		finishSession();
		navigate("/renace");
	};
...
export default ProtectiveFactorsFinalPage;
