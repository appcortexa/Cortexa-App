...
function CopingPlanFinalPage() {
	...
	const handleFinish = () => {
		...
		setIsFinishing(true);
		registerIntervention({ tool: "prevencion-recaidas", exerciseId: "plan-afrontamiento", exerciseTitle: "Plan de Afrontamiento", completed: true });
		finishSession();
		navigate("/renace");
	};
...
export default CopingPlanFinalPage;
