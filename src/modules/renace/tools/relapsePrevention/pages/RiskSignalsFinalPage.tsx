...
function RiskSignalsFinalPage() {
	...
	const handleFinish = () => {
		...
		setIsFinishing(true);
		registerIntervention({ tool: "prevencion-recaidas", exerciseId: "identificacion-senales-riesgo", exerciseTitle: "Identificación de Señales de Riesgo", completed: true });
		finishSession();
		navigate("/renace");
	};
...
export default RiskSignalsFinalPage;
