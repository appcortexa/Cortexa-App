...
function RelapsePersonalPlanFinalPage() {
	...
	const handleFinish = () => {
		...
		setIsFinishing(true);
		registerIntervention({ tool: "prevencion-recaidas", exerciseId: "plan-personal-prevencion-recaidas", exerciseTitle: "Plan Personal de Prevención de Recaídas", completed: true });
		finishSession();
		navigate("/renace");
	};
...
export default RelapsePersonalPlanFinalPage;
