...
function BodyScanFinalPage() {
	...
	const handleFinish = () => {
		...
		setIsFinishing(true);
		registerIntervention({ tool: "mindfulness", exerciseId: "escaneo-corporal", exerciseTitle: "Escaneo Corporal", completed: true });
		finishSession();
		navigate("/renace");
	};
...
export default BodyScanFinalPage;
