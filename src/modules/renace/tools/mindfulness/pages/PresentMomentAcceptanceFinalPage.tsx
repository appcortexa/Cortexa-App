...
function PresentMomentAcceptanceFinalPage() {
	...
	const handleFinish = () => {
		...
		setIsFinishing(true);
		registerIntervention({ tool: "mindfulness", exerciseId: "aceptacion-momento-presente", exerciseTitle: "Aceptación del Momento Presente", completed: true });
		finishSession();
		navigate("/renace");
	};
...
export default PresentMomentAcceptanceFinalPage;
