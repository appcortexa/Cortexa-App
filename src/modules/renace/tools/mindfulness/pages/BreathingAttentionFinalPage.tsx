...
function BreathingAttentionFinalPage() {
	...
	const handleFinish = () => {
		...
		setIsFinishing(true);
		registerIntervention({ tool: "mindfulness", exerciseId: "atencion-respiracion", exerciseTitle: "Atención a la Respiración", completed: true });
		finishSession();
		navigate("/renace");
	};
...
export default BreathingAttentionFinalPage;
