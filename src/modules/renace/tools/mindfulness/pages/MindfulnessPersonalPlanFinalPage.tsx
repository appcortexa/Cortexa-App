...
function MindfulnessPersonalPlanFinalPage() {
	...
	const handleFinish = () => {
		...
		registerIntervention({
			tool: "mindfulness",
			exerciseId: "plan-personal-mindfulness",
			exerciseTitle: "Plan Personal de Mindfulness",
			completed: true,
		});
		finishSession();
		navigate("/renace");
...
export default MindfulnessPersonalPlanFinalPage;
