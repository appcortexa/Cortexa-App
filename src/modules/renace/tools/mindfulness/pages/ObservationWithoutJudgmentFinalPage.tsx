...
function ObservationWithoutJudgmentFinalPage() {
	...
	const handleFinish = () => {
		...
		setIsFinishing(true);
		registerIntervention({ tool: "mindfulness", exerciseId: "observacion-sin-juicio", exerciseTitle: "Observación sin Juicio", completed: true });
		finishSession();
		navigate("/renace");
	};
...
export default ObservationWithoutJudgmentFinalPage;
