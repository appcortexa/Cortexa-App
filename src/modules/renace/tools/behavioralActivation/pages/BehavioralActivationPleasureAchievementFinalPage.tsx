...
function BehavioralActivationPleasureAchievementFinalPage() {
	...
	const handleFinish = () => {
		...
		registerIntervention({
			...
			exerciseId: "registro-placer-logro",
			exerciseTitle: "Registro Placer–Logro",
			completed: true,
		});
		finishSession();
		navigate("/renace");
...
export default BehavioralActivationPleasureAchievementFinalPage;
