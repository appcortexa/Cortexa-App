...
function BehavioralActivationActivityHierarchyFinalPage() {
	...
	const handleFinish = () => {
		...
		registerIntervention({
			...
			exerciseId: "jerarquia-actividades",
			exerciseTitle: "Jerarquía de Actividades",
			completed: true,
		});
		finishSession();
		navigate("/renace");
...
export default BehavioralActivationActivityHierarchyFinalPage;
