...
function PositiveAttentionPersonalPlanFinalPage() {
	...
	const handleFinish = () => {
		...
		registerIntervention({
			...
			exerciseId: "plan-personal",
			exerciseTitle: "Plan Personal de Atención Positiva",
			completed: true,
		});
		finishSession();
		navigate("/renace");
...
export default PositiveAttentionPersonalPlanFinalPage;
