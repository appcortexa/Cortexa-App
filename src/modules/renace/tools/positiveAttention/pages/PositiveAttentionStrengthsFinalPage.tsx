...
function PositiveAttentionStrengthsFinalPage() {
	...
	const handleFinish = () => {
		...
		registerIntervention({
			...
			exerciseId: "fortalezas-personales",
			exerciseTitle: "Fortalezas Personales",
			completed: true,
		});
		finishSession();
		navigate("/renace");
...
export default PositiveAttentionStrengthsFinalPage;
