...
function PositiveAttentionDetectionFinalPage() {
	...
	const handleFinish = () => {
		...
		registerIntervention({
			...
			exerciseId: "deteccion-experiencias",
			exerciseTitle: "Detección de Experiencias Positivas",
			completed: true,
		});
		finishSession();
		navigate("/renace");
...
export default PositiveAttentionDetectionFinalPage;
