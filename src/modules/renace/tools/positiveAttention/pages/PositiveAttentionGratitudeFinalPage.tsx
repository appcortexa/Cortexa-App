...
function PositiveAttentionGratitudeFinalPage() {
	...
	const handleFinish = () => {
		...
		registerIntervention({
			...
			exerciseId: "gratitud-consciente",
			exerciseTitle: "Gratitud Consciente",
			completed: true,
		});
		finishSession();
		navigate("/renace");
...
export default PositiveAttentionGratitudeFinalPage;
