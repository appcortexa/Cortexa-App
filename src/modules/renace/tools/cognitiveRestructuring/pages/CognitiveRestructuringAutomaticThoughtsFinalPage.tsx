...
function CognitiveRestructuringAutomaticThoughtsFinalPage() {
	...
	const handleFinish = () => {
		...
		registerIntervention({
			...
			exerciseId: "deteccion-pensamientos-automaticos",
			exerciseTitle: "Detección de Pensamientos Automáticos",
			completed: true,
		});
		finishSession();
		navigate("/renace");
...
export default CognitiveRestructuringAutomaticThoughtsFinalPage;
