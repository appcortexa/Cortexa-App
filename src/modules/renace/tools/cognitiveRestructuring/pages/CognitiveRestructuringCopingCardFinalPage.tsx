...
function CognitiveRestructuringCopingCardFinalPage() {
	...
	const handleFinish = () => {
		...
		registerIntervention({
			...
			exerciseId: "tarjeta-afrontamiento",
			exerciseTitle: "Tarjeta de Afrontamiento",
			completed: true,
		});
		finishSession();
		navigate("/renace");
...
export default CognitiveRestructuringCopingCardFinalPage;
