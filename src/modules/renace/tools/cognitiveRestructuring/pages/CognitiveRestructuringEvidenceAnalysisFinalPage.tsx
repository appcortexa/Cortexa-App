...
function CognitiveRestructuringEvidenceAnalysisFinalPage() {
	...
	const handleFinish = () => {
		...
		registerIntervention({
			...
			exerciseId: "analisis-evidencias",
			exerciseTitle: "Análisis de Evidencias",
			completed: true,
		});
		finishSession();
		navigate("/renace");
...
export default CognitiveRestructuringEvidenceAnalysisFinalPage;